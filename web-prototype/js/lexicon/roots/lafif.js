...
export const LAFIF_ROOTS = [
  ...
  },
  {
    ...
    forms: {
      I: { bab: 'ai', gloss: 'to be faithful / to keep (a promise)', masdar: 'وَفَاء', trans: false,
  ...
  // --- Lafīf maqrūn · the two weak letters adjacent (طَوَى) -------------------
  {
    ...
    forms: {
      ...
      X: { gloss: 'to be ashamed / to feel shy', masdar: 'اِسْتِحْيَاء', trans: false,
  ...
  },
  {
    ...
    forms: {
      ...
      VIII: { gloss: 'to be level / to be even / to settle upon', masdar: 'اِسْتِوَاء', trans: false,
